...
function slider(){
    ...
    for(let i=0;i<sliderImages.length;i++){
        print+=`<img class="sliderImages img-fluid" src="assets/images/${sliderImages[i]}" alt="${sliderAlt[i]}"/>`
    }
...
function gallery(){
    var images=['gallery1.jpeg','gallery2.jpeg','gallery3.jpeg','gallery4.jpeg','gallery5.jpg','gallery6.jpg','gallery7.jpg','gallery8.jpg']

    let print=''
    for(let i=0;i<images.length;i++){
        print+=`<li data-title="Gallery image" data-desc="Gallery image" data-responsive-src="assets/images/${images[i]}" data-src="assets/images/${images[i]}"> <a href="#"> <img class="img-fluid" src="assets/images/${images[i]}" /> </a> </li>`
    }
...
function questions(){
    ...
    // <a href="#" data-id="${i}" class="text-light showLess d-none"><i class="fas fa-chevron-up"></i></a>
...
function footer(){
    ...
    textAddress.innerText="200, Green road, Mongla, New Yor City USA"
...
function message(){
    ...
    var regName=/^[A-Z][a-z]{2,}(\s[A-Z][a-z]{2,}){1,2}$/;
